...
export const MOCK_STUDIOS: WellnessEntity[] = [
  ...
  },
  {
    ...
    area: 'Sukhumvit',
    points: 80,
    imageUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAXa1njfECmJfLKQOXDQJQKg0oTq1kw6LdQrvPBv3XFo8Iz7binXS0h8CznbdibvgF07CYFhYosDyEEyPV7irDhJBUCPdNeEvScPavEwPQCtuxae-GmlRqSJhR_KHev5yJWoi55E18k6mDV7D5QS7-4_jqQYo3aNHFDtgTtFJz3BKazt9DGSrECaNdtng2KSmnv83oP-MvTgvGf9d6CdrCfn74Bms8m1zQiOVOh7jT_AhelVvkPAx1ak0ABpYyWuEJcNchlXcMyJFTr',
    category: 'Muay Thai',
    startingPrice: 1200
  },
  {
...
export const MOCK_CLASSES: ClassSession[] = [
  {
    ...
    instructor: 'Ananda P.',
    instructorImage: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDjK0AFlmRaKLfGCYKETd9_sGodtxiqpzbZoCEv0vkiikORvG1pUg1paLhEB4pqeIpg3u7FUy8RqL8PidNzFqNu4NxO6B3oLVSRi4TKatqNKtDwV_QYMhdLycL6JMVTALy-tOlB_VwdLPe2OITiQZBv-wbhoNzkWR8niIwl-mqrLsZ0wy-Wo80i9R0e4t6q0lxjkVKj5buojb0fVHJceDlRP4g3ihOpVlNnwvR_vG9zo8tB8_TfVbd68UrVu4XHB5o_OapYo8kF18MO',
    time: '09:30',
    duration: '60 min',
    price: '฿750',
    points: 50,
  ...
  },
  {
    ...
    instructor: 'Somsak K.',
    instructorImage: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDANiPsUbum27jbfGQsMntwX0nZ7g6-VfDZi9XbOml1yktUx5qj3tp0hsm9eiTr4Rx2MchH2-oBbRlUarCjhIuZ6vWVC8aWx3MWqpIJFDg8Rtoh9Ean92xUypwpVTVVwFW4xOpn6FyEYFPw_IW5BCq43S0GM8b2KbVPcjxwAgAwMHqAIaNKL2JezcXZU9GxJC0y8zOTuagKhcpOeFs0Nxr15gyTehHMMMxn6-1g3Mr9oR-PP43OKjANL3d6qrhtzWaa0j-fOm2aIdUY',
    time: '11:00',
    duration: '90 min',
    price: '฿1,200',
    points: 85,
...
export const MOCK_FEED: FeedPost[] = [
  {
    id: 'f1',
    user: 'Kanya S.',
    userImage: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDSeWiz9nhEMqzeiU8lYuJJbXOQQQnb4BPOLs_KSi7GxcKYc6C5ivLvXWSXOrNbNp3FyHaBpGXESRDH9cbaU3KP7oBvh7Ti9956__OzaTSwp_owm7taNUzdBCWygsltnYJbrP4twFL8emAwXGFxIOWtykqed3qoxdgSCMbhmI5Dau7zBwKWiqujqpEbxwmUR5k5uEQbfYkGTq_ljJlNCrGKbTKDQ9urzAIZ01XjHb8gL3hYq6lVzxfrBrmMlHg0ISFGjRsiwUDbEAkb',
